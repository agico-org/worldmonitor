...
const FINANCE_PANELS: Record<string, PanelConfig> = {
  ...
  "fear-greed": { name: "Fear & Greed", enabled: false, priority: 1 },
  fsi: { name: "Financial Stress", enabled: false, priority: 1 },
  "yield-curve": { name: "Yield Curve", enabled: false, priority: 1 },
  "earnings-calendar": {
